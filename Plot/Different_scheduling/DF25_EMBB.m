...
% for i = 1:20:551
%     boxplot(SIM_2hop_RIS25_EMBB_FIFO_A1(:,i).', 'position', time_slot_1_RIS25_index(i), 'labels', time_slot_1_RIS25_index(i), 'colors','r','widths', 1)
%     hold on
%     boxplot(SIM_2hop_RIS25_EMBB_SP_A1(:,i).', 'position', time_slot_1_RIS25_index(i), 'labels', time_slot_1_RIS25_index(i), 'colors','b','widths', 1)
%     hold on   
%     boxplot(SIM_2hop_RIS25_EMBB_EDF_A1(:,i).', 'position', time_slot_1_RIS25_index(i), 'labels', time_slot_1_RIS25_index(i), 'colors','g','widths', 1)
%     hold on
% end
% plot(time_slot_1_RIS25_index, MT_2hop_RIS25_EMBB_FIFO_A1,'Color','r');
% hold on 
% plot(time_slot_1_RIS25_index, MT_2hop_RIS25_EMBB_SP_A1,'Color','b');
% hold on 
% plot(time_slot_1_RIS25_index, MT_2hop_RIS25_EMBB_EDF_A1,'Color','g');
% hold on 

for i = 1:20:551
    boxplot(SIM_2hop_DF25_EMBB_FIFO_A1(:,i).', 'position', time_slot_1_DF25_index(i), 'labels', time_slot_1_DF25_index(i), 'colors','b','widths', 1)
    hold on
    boxplot(SIM_2hop_DF25_EMBB_SP_A1(:,i).', 'position', time_slot_1_DF25_index(i), 'labels', time_slot_1_DF25_index(i), 'colors','r','widths', 2)
    hold on   
    boxplot(SIM_2hop_DF25_EMBB_EDF_A1(:,i).', 'position', time_slot_1_DF25_index(i), 'labels', time_slot_1_DF25_index(i), 'colors','k','widths', 1)
    hold on
end
plot(time_slot_1_DF25_index, MT_2hop_DF25_EMBB_FIFO_A1,':','Color','b','LineWidth',2);
hold on 
plot(time_slot_1_DF25_index, MT_2hop_DF25_EMBB_SP_A1,'Color','r','LineWidth',2);
hold on 
plot(time_slot_1_DF25_index, MT_2hop_DF25_EMBB_EDF_A1,'--','Color','k');
hold on 
...
saveas(gcf,'png\DF25_EMBB.png')
saveas(gcf,'fig\DF25_EMBB.fig')
