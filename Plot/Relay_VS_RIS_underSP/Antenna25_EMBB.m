...
for i = 1:20:551
    boxplot(SIM_2hop_DF25_EMBB_SP_A1(:,i).', 'position', time_slot_1_DF25_index(i), 'labels', time_slot_1_DF25_index(i), 'colors','b','widths', 1)
    hold on   
    boxplot(SIM_2hop_RIS25_EMBB_SP_A1(:,i).', 'position', time_slot_1_RIS25_index(i), 'labels', time_slot_1_RIS25_index(i), 'colors','r','widths', 1)
    hold on
end

plot(time_slot_1_DF25_index, MT_2hop_DF25_EMBB_SP_A1,'Color','b');
hold on 
plot(time_slot_1_RIS25_index, MT_2hop_RIS25_EMBB_SP_A1,'Color','r');
hold on 
...
legend({'DF25\_EMBB','RIS25\_EMBB'},'Location','northeast')

saveas(gcf,'fig/antenna25_EMBB.fig')
saveas(gcf,'png/antenna25_EMBB.png')
