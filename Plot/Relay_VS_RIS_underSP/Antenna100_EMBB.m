...
for i = 1:20:551
    boxplot(SIM_2hop_DF100_EMBB_SP_A1(:,i).', 'position', time_slot_1_DF100_index(i), 'labels', time_slot_1_DF100_index(i), 'colors','b','widths', 1)
    hold on   
    boxplot(SIM_2hop_RIS100_EMBB_SP_A1(:,i).', 'position', time_slot_1_RIS100_index(i), 'labels', time_slot_1_RIS100_index(i), 'colors','r','widths', 1)
    hold on
end

plot(time_slot_1_DF100_index, MT_2hop_DF100_EMBB_SP_A1,'Color','b');
hold on 
plot(time_slot_1_RIS100_index, MT_2hop_RIS100_EMBB_SP_A1,'Color','r');
hold on 
ax = gca; 
ax.YAxis.Scale ="log";
...
xlabel('delay (ms)')
ylabel('probability')
legend({'DF100\_EMBB','RIS100\_EMBB'},'Location','northeast')

saveas(gcf,'fig/antenna100_EMBB.fig')
saveas(gcf,'png/antenna100_EMBB.png')
